...
// });
  ...
  return (
    <div className="isolate bg-gray-50 px-6 py-16 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">We're here to answer your queries.</p>
      </div>
